...
function listGenerator(countries) {
  ...
  countries.forEach((newCountry, index) => {
    ...
    content = `<p class='flag'><img src='${newCountry.flag}'></p>
    <p class='name'>${newCountry.name}</p>
      <p class='capital'>${newCountry.capital}</p>
      <p class='language'>${newCountry.languages.join(', ')}</p>
      <p class='population'>${newCountry.population.toLocaleString()}</p>`;
...
function filterCountries() {
  ...
  search.value != ''
    ? (listInfo.innerHTML = `We found you ${countriesFilter.length} Countries`)
    : (listInfo.innerHTML = '');
